...
from ref.multi_gpu_learner_thread import MultiGPULearnerThread
...
from ref.concurrency_ops import Concurrently, Enqueue, Dequeue
from ref.metric_ops import StandardMetricsReporting
...
class ImpalaTrainer(Trainer):
    ...
    def execution_plan(workers, config, **kwargs):
        ...
        # enqueue_op=enqueue_op.for_each(lambda x: print("===== execute enqueue ======"))
        ...
        # dequeue_op=dequeue_op.for_each(lambda x: print(f"======== execute dequeue; none: {isinstance(x,_NextValueNotReady)} ======="))
        # dequeue_op=dequeue_op.for_each(lambda x: print(f"======== execute dequeue ======="))
